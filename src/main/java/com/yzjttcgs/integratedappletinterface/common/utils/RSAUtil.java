...
public class RSAUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        s = "{\"instid\":\"10000001\",\"txncode\":\"queryoutspace\",\"parktime\":\"003000\",\"mchntid\":\"100000010000001\",\"txntime\":\"20170116144131\",\"carseatid\":\"000001\",\"seqid\":\"2017011614413135430\"}";
        ...
        System.out.println(new BigInteger(wer.signRSA(s.getBytes(), false, "utf-8")).toString(16));
        System.out.println(NumberStringUtil.bytesToHexString(wer.signRSA(s.getBytes(), false, "utf-8")));

        BigInteger bi = new BigInteger(sign, 16);
        System.out.println(bi.toByteArray().length);
        System.out.println(NumberStringUtil.hexStringToBytes(sign).length);
